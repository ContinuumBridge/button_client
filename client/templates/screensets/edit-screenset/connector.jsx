...
(function () {
    ...
    var _jp = jsPlumb, _ju = jsPlumbUtil;
    ...
    var CBConnection = function (params) {
        params = params || {};
        this.type = "CB";

        var _super = _jp.Connectors.AbstractConnector.apply(this, arguments),
            curviness = params.curviness || 30,
    ...
    _ju.extend(CBConnection, _jp.Connectors.AbstractConnector);
    _jp.registerConnectorType(CBConnection, "CB");
}).call(this);
